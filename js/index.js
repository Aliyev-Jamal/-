...
const questionsLines = [
    ...
    },
    {
        ...
        answer: 2,
        feedback: ['Мы чуть не надорвали спину пока его пытались поднять. -10 очков!', 'Мы разбили камень, а зачем? Зря потратили время. -10 очков!', 'Мы прошли мимо и нашли за камнем арматуру. В хозяйстве пригодится! +10 очков!']
    },
    {
